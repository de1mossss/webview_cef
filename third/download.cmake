...
function(extract_file filename extract_dir)
    message(STATUS "[webview_cef] ${filename} will extract to ${extract_dir} ...")
...
function(download_file url filename)
    message(STATUS "[webview_cef] Downloading ${filename} from ${url}")
...
function(prepare_prebuilt_files filepath)
    ...
    if(need_download)
        message(STATUS "[webview_cef] Need to update ${filepath}")
